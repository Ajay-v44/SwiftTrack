...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleJsonMappingException(
        ...
        System.err.println("[TENANT-SERVICE] JSON Parsing Error at " + path + ": " + message);
    ...
    public ResponseEntity<Map<String, Object>> handleCustomException(
        ...
        System.err.println("[TENANT-SERVICE] Custom Exception at " + path + ": " + ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleResourceNotFoundException(
        ...
        System.err.println("[TENANT-SERVICE] Resource Not Found at " + path + ": " + ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleGlobalException(
        ...
        System.err.println("[TENANT-SERVICE] Unexpected Error at " + path + ": " + message);
        ex.printStackTrace();
