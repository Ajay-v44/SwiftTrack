...
public class MatrixResponse implements Serializable {
    ...
    public Double getDistance(int originIndex, int destinationIndex) {
        ...
        if (originIndex >= distances.size()) return null;
        if (destinationIndex >= distances.get(originIndex).size()) return null;
    ...
    public Double getDuration(int originIndex, int destinationIndex) {
        ...
        if (originIndex >= durations.size()) return null;
        if (destinationIndex >= durations.get(originIndex).size()) return null;
    ...
    public Integer getClosestDestination(int originIndex) {
        if (distances == null || originIndex >= distances.size()) return null;
    ...
    public Integer getFastestDestination(int originIndex) {
        if (durations == null || originIndex >= durations.size()) return null;
