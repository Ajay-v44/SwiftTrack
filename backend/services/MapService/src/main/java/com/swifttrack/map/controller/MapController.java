...
public class MapController {
    ...
    @GetMapping("/reverse")
    @Operation(summary = "Reverse Geocoding", description = "Convert latitude/longitude coordinates to a human-readable address")
    ...
    @GetMapping("/search")
    @Operation(summary = "Forward Geocoding", description = "Convert an address or place name to coordinates")
    public ResponseEntity<ApiResponse<List<NormalizedLocation>>> search(
            @Parameter(description = "Address or place to search", example = "MG Road, Bangalore") @RequestParam String query,
            @Parameter(description = "Maximum number of results (1-50)") @RequestParam(defaultValue = "5") int limit) {
    ...
    @Operation(summary = "Get Directions", description = "Calculate route with turn-by-turn directions between two points")
    ...
    @Operation(summary = "Get Directions (GET)", description = "Simple directions query via GET parameters")
    ...
    @PostMapping("/matrix")
    @Operation(summary = "Distance Matrix", description = "Calculate distances and durations between multiple origin-destination pairs")
    ...
    @PostMapping("/eta")
    @Operation(summary = "ETA Calculation", description = "Calculate estimated time of arrival with traffic considerations")
    ...
    @GetMapping("/eta")
    @Operation(summary = "ETA Calculation (GET)", description = "Simple ETA query via GET parameters")
    ...
    @PostMapping("/snap")
    @Operation(summary = "Snap to Road", description = "Snap GPS coordinates to the nearest road segment")
    ...
    @GetMapping("/snap")
    @Operation(summary = "Snap Single Point", description = "Snap a single GPS coordinate to the nearest road")
    ...
    @Operation(summary = "Serviceability Check", description = "Check if a point is inside a defined service area polygon")
    ...
    @Operation(summary = "Radius Check", description = "Check if a point is within a circular service area")
    ...
    @GetMapping("/distance")
    @Operation(summary = "Calculate Distance", description = "Calculate straight-line distance between two points (Haversine)")
    ...
    public record DistanceResult(
            ...
            @com.fasterxml.jackson.annotation.JsonProperty("distance_meters") double distanceMeters,
            @com.fasterxml.jackson.annotation.JsonProperty("distance_text") String distanceText) {
    }
}
